...
def clusteringAnalysisKMeans (x_data, y_data) :
    ...
    dir = os.path.join("./","Dataset01_Plots")
   ...
   # plt.plot(kClusters, testAccuracyCTuned, 'rs' , label='Test Accuracy')
    ...
    plt.savefig('./Dataset01_Plots/KMeansSSE.png', bbox_inches='tight')
    ...
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/KMeansScores.png', bbox_inches='tight')
    plt.show()
...
def clusteringAnalysisEMaximization (x_data, y_data):
    print("Starting  Expectation Maximization Analysis.....");
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    ...
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/EMProbability.png', bbox_inches='tight')
    plt.show(block=False)
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    ...
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/EMScores.png', bbox_inches='tight')
    plt.show()
...
def clusteringAnalysisPCA (x_data, y_data):
    ...
    ax1.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/evsvPCA.png', bbox_inches='tight')
    plt.show(block=False)
   ...
   # plt.plot(kClusters, testAccuracyCTuned, 'rs' , label='Test Accuracy')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/PCAKMeansSSE.png', bbox_inches='tight')
    plt.show(block=False)
    ...
    plt.plot(kClusters, amiScoreKM, 'r--', linewidth=3 , markersize=8, label='AMI Score')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/PCAKMeansScores.png', bbox_inches='tight')
    plt.show()
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    plt.plot(mComponents, scoreSamplesEM, 'go-', linewidth=3 , markersize=8, label='Avg. Log Likelihood')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/PCAEMProbability.png', bbox_inches='tight')
    plt.show(block=False)
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    ...
    plt.plot(mComponents, bicSCoreEM, 'r--', linewidth=3 , markersize=8, label='BIC Score')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/PCAEMScores.png', bbox_inches='tight')
    plt.show()
...
def clusteringAnalysisICA (x_data, y_data):
   ...
   # ax2 = ax1.twinx()
    ...
    #ax1.plot(np.nan, 'rs-', label = 'Singular Values')
    ax1.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/kurtICA.png', bbox_inches='tight')
    plt.show(block=False)
   ...
   # plt.plot(kClusters, testAccuracyCTuned, 'rs' , label='Test Accuracy')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/ICAKMeansSSE.png', bbox_inches='tight')
    plt.show(block=False)
    ...
    plt.plot(kClusters, amiScoreKM, 'r--', linewidth=3 , markersize=8, label='AMI Score')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/ICAKMeansScores.png', bbox_inches='tight')
    plt.show()
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    plt.plot(mComponents, scoreSamplesEM, 'go-', linewidth=3 , markersize=8, label='Avg. Log Likelihood')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/ICAEMProbability.png', bbox_inches='tight')
    plt.show(block=False)
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    ...
    plt.plot(mComponents, bicSCoreEM, 'r--', linewidth=3 , markersize=8, label='BIC Score')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/ICAEMScores.png', bbox_inches='tight')
    plt.show()
...
def clusteringAnalysisRPA (x_data, y_data):
    ...
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/meanRPA.png', bbox_inches='tight')
    plt.show(block=False)
    ...
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/stdRPA.png', bbox_inches='tight')
    plt.show(block=False)
   ...
   # plt.plot(kClusters, testAccuracyCTuned, 'rs' , label='Test Accuracy')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/RPAKMeansSSE.png', bbox_inches='tight')
    plt.show(block=False)
    ...
    plt.plot(kClusters, amiScoreKM, 'r--', linewidth=3 , markersize=8, label='AMI Score')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/RPAKMeansScores.png', bbox_inches='tight')
    plt.show()
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    plt.plot(mComponents, scoreSamplesEM, 'go-', linewidth=3 , markersize=8, label='Avg. Log Likelihood')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/RPAEMProbability.png', bbox_inches='tight')
    plt.show(block=False)
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    ...
    plt.plot(mComponents, bicSCoreEM, 'r--', linewidth=3 , markersize=8, label='BIC Score')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/RPAEMScores.png', bbox_inches='tight')
    plt.show()
...
def clusteringAnalysisLDA (x_data, y_data):
    ...
    plt.figure('LDA_01')
    fig, ax1 = plt.subplots()
    plt.title('LDA: Explained Vriance', fontsize=16);
    ...
    #ax1.plot(np.nan, 'rs-', label = 'Singular Values')
    ax1.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/evsvLDA.png', bbox_inches='tight')
    plt.show(block=False)
   ...
   # plt.plot(kClusters, testAccuracyCTuned, 'rs' , label='Test Accuracy')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/LDAKMeansSSE.png', bbox_inches='tight')
    plt.show(block=False)
    ...
    plt.plot(kClusters, amiScoreKM, 'r--', linewidth=3 , markersize=8, label='AMI Score')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/LDAKMeansScores.png', bbox_inches='tight')
    plt.show()
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    plt.plot(mComponents, scoreSamplesEM, 'go-', linewidth=3 , markersize=8, label='Avg. Log Likelihood')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/LDAEMProbability.png', bbox_inches='tight')
    plt.show(block=False)
...
#    plt.plot(mComponents, hmScoreKM, 'go--', linewidth=3, markersize=8, label='Homogeneity Score')
    ...
    plt.plot(mComponents, bicSCoreEM, 'r--', linewidth=3 , markersize=8, label='BIC Score')
    plt.legend(loc='best', fontsize=12)
    plt.savefig('./Dataset01_Plots/LDAEMScores.png', bbox_inches='tight')
    plt.show()
