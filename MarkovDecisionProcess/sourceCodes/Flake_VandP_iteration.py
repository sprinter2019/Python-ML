...
def plot_figures(scores, episodes, gamma, iterType):
    ...
    plt.savefig('./A4_Plots/%sFlake_Reward_g%0.2f.png' %(iterType, gamma), bbox_inches='tight')
    plt.show()
...
run_discrete('FrozenLake-v0', mapping, gamma=0.90, shape=shape)
run_discrete('FrozenLake-v0', mapping, gamma=0.95, shape=shape)
run_discrete('FrozenLake-v0', mapping, gamma=0.50, shape=shape)
run_discrete('FrozenLake-v0', mapping, gamma=1.00, shape=shape)
...
#run_discrete('Taxi-v3', mapping, gamma=0.99)
