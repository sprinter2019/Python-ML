...
plt.savefig('./A4_Plots/qFL_score_LR60_Eps10.png', bbox_inches='tight')
...
plt.savefig('./A4_Plots/qFL_iter_LR60_Eps10.png', bbox_inches='tight')
plt.show(block=False)
...
plt.xlabel('Episode')
plt.ylabel('Time (s)')
plt.savefig('./A4_Plots/qFL_time_LR60_Eps10.png', bbox_inches='tight')
plt.show()
